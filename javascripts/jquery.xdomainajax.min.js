...
delete a.complete);var d=a.success;a.success=function(a){d&&d.call(this,{responseText:(a.results[0]||"").replace(/<script[^>]+?\/>|<script(.|\s)*?\/script>/gi,"")},"success")}}return b.apply(this,arguments)}}(jQuery.ajax);
